---
name: morning-brief
description: "AI产品经理专属定制早报系统。每天早上8点自动发送AI资讯、全球新闻和赚钱机会到Feishu。"
---

# Morning Brief Skill

专为AI产品经理设计的个性化早报系统。每天早上8点(GMT+8)自动收集AI前沿动态、全球要闻和赚钱机会，生成结构化早报并发送到Feishu。

## 用户画像

- **身份**: AI产品经理
- **核心需求**: 
  1. AI领域最新资讯（技术突破、产品发布、竞品动向）
  2. 全球重要新闻（科技政策、经济事件、市场波动）
  3. 赚钱机会挖掘（产品机会、变现模式、投资风向）
